...
import authRoutes from './routes/auth'; // <--- 1. IMPORTAMOS A ROTA AQUI
...
// Rotas de Usuários (ex: POST /users/register)
app.route('/users', userRoutes);

// Rotas de Autenticação (ex: POST /auth/login)
app.route('/auth', authRoutes); // <--- 2. REGISTRAMOS A ROTA AQUI
